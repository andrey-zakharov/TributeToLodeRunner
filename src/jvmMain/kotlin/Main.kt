...
suspend fun main(args: Array<String>) = KoolApplication(
    config = KoolConfig(
        assetPath =  "assets",
        renderBackend = Lwjgl3Context.Backend.OPEN_GL,
        windowTitle = "Tribute to Lode Runner by Andrey Zakharov 2022"
    )
) {
...
/*            debugOnly {
    ...
    /*}*/
    val scene = if (args.isNotEmpty()) AppState.valueOf(args[0].uppercase())
